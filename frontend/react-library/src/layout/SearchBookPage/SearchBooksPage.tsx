...
export const SearchBooksPage = () => {
    ...
    useEffect(() => {
        ...
        //every time this useEffect is called, we scroll to the top [real nice]
        window.scrollTo(0, 0);
        //each time a single piece of state changes that we type in here, recall this useEffect hook
    }, [currentPage]);
