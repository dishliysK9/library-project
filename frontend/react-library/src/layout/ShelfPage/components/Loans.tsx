...
export const Loans = () => {
    ...
    useEffect(() => {
        const fetchUserCurrentLoans = async () => {
            if (authState && authState.isAuthenticated) {
                const url = config.url.BASE_URL + `books/secure/currentloans`;
    ...
    async function returnBook(bookId: number) {
        const url = config.url.BASE_URL + `books/secure/return/?bookId=${bookId}`;
        const requestOptions = {
            method: 'PUT',
            headers: {
                Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
    ...
    async function renewLoan(bookId: number) {
        const url = config.url.BASE_URL + `books/secure/renew/loan/?bookId=${bookId}`;
        const requestOptions = {
            method: 'PUT',
            headers: {
                Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
